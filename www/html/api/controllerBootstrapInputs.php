<?php
    ...
    $controllerBootstrapInputs = new controllerBootstrapInputs();
    ...
    try {
        ...
        if(isset($_GET_lower['id'])){
            ...
            $controllerBootstrapInputs->id = $_GET_lower['id'];
        }
        ...
        switch(strtolower($_SERVER['REQUEST_METHOD'])){
            ...
            case "get":
                ...
                if($controllerBootstrapInputs->id != NULL){

                    #Get the specific ID requested
                    print($controllerBootstrapInputs->get());
                }
    ...
    class controllerBootstrapInputs{
        ...
        function get(){
            ...
            if($this->id != NULL){
                $response = $database->query("SELECT json FROM getBootstrapInputs WHERE id = " . $this->id . ";");
